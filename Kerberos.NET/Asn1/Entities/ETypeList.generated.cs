...
namespace Kerberos.NET.Asn1.Entities
{
    ...
    public partial struct ETypeList
    {
        ...
        public static ETypeList Decode(ReadOnlyMemory<byte> data)
        {
            return Decode(data, AsnEncodingRules.DER);
        }

        internal static ETypeList Decode(ReadOnlyMemory<byte> encoded, AsnEncodingRules ruleSet)
        {
            AsnReader reader = new AsnReader(encoded, ruleSet);
            
            Decode(reader, out ETypeList decoded);
            reader.ThrowIfNotEmpty();
            return decoded;
        }

        internal static void Decode(AsnReader reader, out ETypeList decoded)
        {
            if (reader == null)
