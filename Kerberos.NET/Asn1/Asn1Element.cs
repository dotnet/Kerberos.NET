        ...
        private void DebugPrint(Asn1Element element, int indent)
        {
            ...
            switch (element.Class)
            {
                case TagClass.Application:
                    Debug.WriteLine($"{tabs}[APPLICATION {element.ApplicationTag}] {element.Count}");
                    break;
                case TagClass.ContextSpecific:
                    Debug.WriteLine($"{tabs}[{element.ContextSpecificTag}] {element.Count}");
                    break;
                case TagClass.Private:
                    break;
                case TagClass.Universal:
                    Debug.WriteLine($"{tabs}[{element.UniversalTag}] {element.Count}");
                    break;
            }
