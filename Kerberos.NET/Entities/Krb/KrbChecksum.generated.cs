...
{
    public partial class KrbChecksum : IAsn1Encoder
    {
        ...
        internal static void Decode(AsnReader reader, out KrbChecksum decoded)
        {
            if (reader == null)
        ...
        internal static void Decode(AsnReader reader, Asn1Tag expectedTag, out KrbChecksum decoded)
        {
            if (reader == null)
                throw new ArgumentNullException(nameof(reader));

            decoded = new KrbChecksum();
