...
namespace Kerberos.NET.Crypto
{
    ...
    {
        // Originally implemented by https://github.com/bcgit/bc-csharp/blob/master/crypto/src/crypto/digests/Sha1Digest.cs
        // License belongs to BC and the origins of the algorithm
