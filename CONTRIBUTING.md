...
* You [license](https://github.com/dotnet/Kerberos.NET/blob/develop/LICENSE) the contribution under the terms applied to the rest of the Kerberos.NET project.
* You agree to follow the [code of conduct](https://github.com/dotnet/Kerberos.NET/blob/develop/CODE_OF_CONDUCT.md).
...
Note that the coding style does diverge from the above guidelines and the current up-to-date ruleset can be found here: [CodeAnalysisRules.ruleset](https://github.com/dotnet/Kerberos.NET/blob/develop/CodeAnalysisRules.ruleset).
...
If you want to introduce a dependency to the Kerberos.NET library or tooling, make sure you bring it
 ...
 * Through GitHub (preferred),
   you talk about a feature you would like to see (or a bug), and why it should be in Kerberos.NET.
 * Alternatively, if a feature is on the issues list with the
   [Up For Grabs](https://github.com/dotnet/Kerberos.NET/labels/up-for-grabs) label,
 ...
 * Once you feel it is ready, submit the pull request to the `dotnet/Kerberos.NET` repository against the `develop` branch
 ...
 * One of the Kerberos.NET team members, or one of the maintainers, will evaluate it within a
 ...
 * `git fetch upstream` (upstream would be the mainstream repo or `dotnet/Kerberos.NET` in this case)
 * `git checkout develop`
 * `git rebase upstream/develop`
 * `git checkout your-branch`
 * `git rebase develop`
 * Fix any merge conflicts
 * `git push origin your-branch` (origin would be your GitHub repo or `your-github-username/Kerberos.NET` in this case).
...
This contribution guide was taken from the [Cake Build Project](https://github.com/cake-build/cake/blob/develop/CONTRIBUTING.md) which was derived from the [Chocolatey project](https://chocolatey.org/) with permission and was edited to follow Kerberos.NET's conventions and processes.
